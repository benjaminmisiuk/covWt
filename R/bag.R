...
#' 
#' @return A list containing the bootstrapped sample data `$data`, a vector of indices `$oob` indicating which samples were drawn, 
#' and a vector `$x` of which predictor variables were selected.
#' 
#' @examples
#' data(iris)
#' 
...
bag <- function(y, x, data, p = rep(1, nrow(data)), mtry = length(x), mtry_replace = FALSE){
